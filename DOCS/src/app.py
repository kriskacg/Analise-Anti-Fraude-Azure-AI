...
def configure_interface():
    st.title=("Upload de Arqiuvo DIO - Desafio - Azure - Fake Docs")
    ...
    if uploaded_file is not None:
        ...
        if blob_url:
            ...
            credit_card_info = analyze_credit_card(blob_url) #Chama a função de detecção de inforações de cartão de crédito
